            ...
            <footer className="page-footer text-white row text-center">
                <div className='footer-content'>
                    ...
                    <div className="footer-icons ">
                        ...
                        Better sites:
                        <a className="btn btn-floating " href="https://www.facebook.com" alt="Facebook" role="button">
                        ...
                        <a className="btn btn-floating " href="https://www.twitter.com" alt="Twitter" role="button">
                            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='#000000' width='24'
                                height='24'>
                                <path
                        ...
                        <a className="btn btn-floating " href="https://www.instagram.com" alt="Instagram" role="button">
                            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='#000000' width='24'
                                height='24'>
                                <path
